...
function toEqual(actual: unknown, expected: unknown): { pass: boolean; message: string } {
...
function toContain(actual: unknown, expected: unknown): { pass: boolean; message: string } {
  let pass = false;
...
function toBeStatus(actual: unknown, expected: unknown): { pass: boolean; message: string } {
...
function toHaveText(actual: unknown, expected: unknown): { pass: boolean; message: string } {
  const pass =
...
function toBeGreaterThan(actual: unknown, expected: unknown): { pass: boolean; message: string } {
...
function toBeTruthy(actual: unknown): { pass: boolean; message: string } {
